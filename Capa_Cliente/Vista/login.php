...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM cliente WHERE Documento_Cliente = '$documento_cliente' AND Contraseña_Cliente = '$contrasena_cliente'";
    $result = $conn->query($sql);

    if ($result->num_rows > 0) {
        // Si el usuario existe, redirigir a index.html
